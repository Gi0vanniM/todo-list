...
<div class="list-container px-2 mt-3">
    ...
    <button class="btn add-list-btn" type="button" id="dropdownAddList" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-offset="0, -10">Add a list</button>
